...
% periodic condition.
% 
% Lax-Friedrichs flux splitting is used for stability: 
%
%     q2 \approx FU2: positive flux at x_{j+1/2}
%     q1 \approx FU1: negative flux at x_{j+1/2}
% 
% FU: nv-by-Nx, where nv is the number of the variables of vectorial
